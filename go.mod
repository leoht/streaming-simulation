module leohetsch.com/simulation
...
require (
	...
	leohetsch.com/simulation/consumer v0.0.0-00010101000000-000000000000
	leohetsch.com/simulation/producer v0.0.0-00010101000000-000000000000
)
